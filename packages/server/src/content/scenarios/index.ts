...
import { IT_OPENS_DOORS, IT_OPENS_DOORS_TRUTH } from './door-controller.js';
import { THEY_KNEW_WHICH_LORRY, THEY_KNEW_WHICH_LORRY_TRUTH } from './fleet-telematics.js';
import { IT_SAYS_MALWARE, IT_SAYS_MALWARE_TRUTH } from './sinkhole.js';
import { OUR_OWN_NAME, OUR_OWN_NAME_TRUTH } from './dependency-confusion.js';
import { THE_PATCH_EXISTS, THE_PATCH_EXISTS_TRUTH } from './unpatchable-device.js';
import { BEYOND_WHAT_THEY_SAID, BEYOND_WHAT_THEY_SAID_TRUTH } from './researcher-report.js';
import { THE_DIAGRAM_SAYS_ISOLATED, THE_DIAGRAM_SAYS_ISOLATED_TRUTH } from './guest-network.js';
import { THEY_SAID_YES, THEY_SAID_YES_TRUTH } from './oauth-consent.js';
import { EVERYBODY_IS_ADMIN, EVERYBODY_IS_ADMIN_TRUTH } from './shared-admin.js';
import { THE_PHONE_NUMBER_WAS_THE_PASSWORD, THE_PHONE_NUMBER_WAS_THE_PASSWORD_TRUTH } from './sim-swap.js';
import { DO_NOT_TOUCH_IT, DO_NOT_TOUCH_IT_TRUTH } from './legal-hold.js';
import { THE_VAULT_DID_ITS_JOB, THE_VAULT_DID_ITS_JOB_TRUTH } from './secrets-vault.js';
import { FORTY_PEOPLE_TOLD_US, FORTY_PEOPLE_TOLD_US_TRUTH } from './report-button.js';
import { BEFORE_IT_HAPPENED, BEFORE_IT_HAPPENED_TRUTH } from './clock-skew.js';
import { SOMEBODY_ELSES_DOMAIN, SOMEBODY_ELSES_DOMAIN_TRUTH } from './lapsed-domain.js';
import { EVERYONE_ON_THE_CALL, EVERYONE_ON_THE_CALL_TRUTH } from './synthetic-call.js';
import { BACK_TO_TUESDAY, BACK_TO_TUESDAY_TRUTH } from './restore-reinfect.js';
import { DAY_ONE, DAY_ONE_TRUTH } from './acquisition.js';
import { ONLY_A_TEST_SYSTEM, ONLY_A_TEST_SYSTEM_TRUTH } from './test-system.js';
import { SOMEBODY_AUTHORISED_THIS, SOMEBODY_AUTHORISED_THIS_TRUTH } from './unannounced-test.js';
import { OUR_OWN_CONSOLE, OUR_OWN_CONSOLE_TRUTH } from './compromised-edr.js';
import { HELPFUL_TOOLS, HELPFUL_TOOLS_TRUTH } from './shadow-ai.js';
import { HOW_MANY, HOW_MANY_TRUTH } from './how-many.js';
import { THEIR_PHONE, THEIR_PHONE_TRUTH } from './byod.js';
import { HANDOVER, HANDOVER_TRUTH } from './handover.js';
import { NO_EVIDENCE, NO_EVIDENCE_TRUTH } from './vendor-integration.js';
import { OUR_OWN_CUSTOMERS, OUR_OWN_CUSTOMERS_TRUTH } from './retry-storm.js';
import { WE_TAUGHT_IT_THAT, WE_TAUGHT_IT_THAT_TRUTH } from './model-drift.js';
import { THE_FIFTH_WARNING, THE_FIFTH_WARNING_TRUTH } from './fifth-warning.js';
import { LOUD_ON_PURPOSE, LOUD_ON_PURPOSE_TRUTH } from './decoy-miner.js';
import { ONE_OF_OURS, ONE_OF_OURS_TRUTH } from './soc-insider.js';
import { THEY_TOLD_US_FIRST, THEY_TOLD_US_FIRST_TRUTH } from './disclosure.js';
