...
export const SCENARIOS: Scenario[] = [RIDGELINE, LOW_TIDE, LONG_NOTICE, THIRD_PARTY, CHEAP_RENT, SECOND_POST, LONG_WEATHER, QUIET_CHANNEL, KEY_RING, NO_PATCH, LAST_FRIDAY, NOTHING_INSTALLED, NOTHING_TO_RESTORE, SIGNED_AND_TRUSTED, SECOND_FLOOR, WRONG_ADDRESS, BAD_TEACHER, ALL_AT_ONCE, BELOW_THE_FLOOR, CRY_WOLF, CHANGE_OF_BANK, INFUSION, OWN_KEYS, SELECT_STAR, FOUND_IN_THE_CAR_PARK, NOTHING_LEFT, GOLDEN_HOUR, CERTIFICATE_OF_TRUST, SOMEBODY_ELSES_BREACH, CONTRACTORS_LAPTOP, SHADOW_COPY, ALREADY_LOGGED_IN, APPROVE_APPROVE_APPROVE, HELPDESK_SAYS_YES, OPEN_SHELF, OUT_OF_THE_BOX, THE_BUILD_SAYS_SO, EVERYONE_HAS_IT, THE_APP_KNOWS];
