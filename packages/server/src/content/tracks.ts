...
export const TRACKS: Track[] = [
  // --- defensive operations -------------------------------------------------
  {
    ...
    curriculum: [
      ...
      { title: 'Help Desk Ticketing System', summary: 'How work actually arrives before it is ever an alert: intake, priority built on impact and urgency, real ownership, and closing well.', packageId: 'helpdesk-ticketing-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      ...
      { title: 'Threat Hunter Foundations', summary: 'The one seat that goes looking: the assume-breach mindset, a testable hunt hypothesis, and how the role differs from the reactive seats around it.', packageId: 'threat-hunter-foundations' },
      { title: 'Forensics Foundations', summary: 'How evidence is recovered and preserved so it holds up: order of volatility, hashing before you touch, and chain of custody.', packageId: 'forensics-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      ...
      { title: 'Detection Engineering', summary: 'Write a rule as a pattern you can run, measure what it costs in noise, tune it without going blind, and back it with a regression test and a coverage map.', packageId: 'detection-engineering-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      ...
      { title: 'Threat Intelligence Foundations', summary: 'What intelligence adds that the incident alone cannot, the discipline of restraint in attribution, and why behaviour outlasts indicators.', packageId: 'threat-intel-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      { title: 'Application Security Foundations', summary: 'Injection, XSS, broken auth and access control, deserialisation and SSRF, secure code review, and threat modelling without becoming the department of no.', packageId: 'appsec-foundations' },
  ...
  // --- platform and infrastructure -----------------------------------------
  {
    ...
    curriculum: [
      { title: 'Cloud Security Foundations', summary: 'Shared responsibility, IAM as the new perimeter, storage exposure, network boundaries, logging, secrets, infrastructure as code, and cloud incident response.', packageId: 'cloud-security-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      ...
      { title: 'Active Directory Home Lab', summary: 'Promote a domain controller, organise users and groups with OUs, enforce policy with Group Policy, and join a client, then know what to check when any of it quietly does not work.', packageId: 'windows-ad-foundations' },
  ...
  },
  {
    ...
    curriculum: [
      { title: 'Security Engineering Foundations', summary: 'What this seat builds versus monitors or assesses: hardening, segmentation, endpoint architecture, logging pipeline design, applied cryptography, infrastructure identity, and change management at scale.', packageId: 'security-engineering-foundations' },
